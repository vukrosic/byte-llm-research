...
import time
# Removed tokenizer import for byte-level processing
...
class ModelConfig:
    ...
    # Technical
    use_amp: bool = True
    vocab_size: int = 256  # Fixed to 256 for byte-level (0-255)
...
def train_model(config: ModelConfig, train_loader: DataLoader, val_loader: DataLoader):
    ...
    print(f"\n🚀 Training Byte-level model with Muon optimizer")
...
if __name__ == "__main__":
    ...
    # Load data
    texts, _, bytes_data = load_and_cache_data(config)
